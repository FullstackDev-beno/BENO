...
const SOURCE_ARTICLES: Record<string, Article[]> = {
  "AI & Automation": [
    ...
    { category:"AI", read:"6 MIN", title:"RAG vs Fine-Tuning: Choosing Your Strategy", excerpt:"A practical guide to when retrieval augmentation beats model fine-tuning.", thumb:"https://images.unsplash.com/photo-1655720828083-e40e3f930b9b?w=600&q=80" },
